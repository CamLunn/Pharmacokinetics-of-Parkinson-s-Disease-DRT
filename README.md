...
- Rytary_Dynamics.m: matlab file used to simulate dynamics of Rytary. Shows dosing regimen and levodopa levels in the periphery and central nervous system for Rytary (Figure 6).
- Sinemet_Dynamics.m: script to simulate dynamics of Sinemet. Shows dosing regimen and levodopa levels in the periphery and central nervous system for Sinemet (Figure 7).
